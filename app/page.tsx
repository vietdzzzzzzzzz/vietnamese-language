        ...
        <div className="container px-4 sm:px-8 py-4 mx-auto">
          <nav className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 text-lg font-bold sm:text-xl">
              <Dumbbell className="w-5 h-5 text-primary sm:w-6 sm:h-6" />
              GYMORA
            </Link>
        ...
        <div className="container px-4 sm:px-8 py-20 mx-auto md:py-32">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-base text-muted-foreground text-pretty leading-relaxed sm:text-xl">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <Button asChild size="lg" variant="outline" className="text-base sm:text-lg bg-transparent">
      ...
      <section className="py-20 md:py-32">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-2xl font-bold mb-4 text-balance sm:text-4xl">Tính năng vượt trội</h2>
            <p className="text-base text-muted-foreground text-pretty sm:text-xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">AI Phân tích tiến độ</h3>
            ...
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">Kế hoạch cá nhân hóa</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">Chat AI hỗ trợ</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">Theo dõi tiến độ</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">Quản lý member</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 space-y-4 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold sm:text-xl">Admin Dashboard</h3>
              <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-20 md:py-32 bg-muted/30 border-t">
        <div className="container px-4 sm:px-8 mx-auto">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h2 className="text-2xl font-bold text-balance sm:text-4xl">Sẵn sàng nâng cấp phòng gym của bạn?</h2>
            <p className="text-base text-muted-foreground text-pretty sm:text-xl">
